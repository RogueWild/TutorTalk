...
const SummaryInput = ({}) => {
    ...
    return <SummaryInputCont onClick={()=> {
        ...
        <SummaryInputBox>
            ...
            <InputText placeholder={"Work Experience"} margin={"50px 0 0 0"} width={"45%"}/>
        </SummaryInputBox>
        <SummaryInputBox>
            <SummaryInputImg src={"cap.png"}/>
            <InputText placeholder={"Level of Education"} margin={"15px 0 0 0"} width={"45%"}/>
        </SummaryInputBox>
        <SummaryInputBox>
            <InputText placeholder={"Hours of Availability, Zoom Link"} margin={"15px 0 0 46px"} width={"45%"}/>
        </SummaryInputBox>
