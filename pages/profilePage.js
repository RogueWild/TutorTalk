    ...
    return (
        ...
        <div className="content-box">
            ...
            <div className="right-side">
                ...
                <div className="about-box">
                    <AboutBox color={0} text2={"Tips"} text={"Make sure you take notes during class and complete your homework as soon as possible once it has been assigned. That way the lesson is still fresh in your mind."} size={0}/>
                </div>
            </div>
        </div>
        </div>
